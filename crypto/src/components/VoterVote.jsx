    ...
    <div className="min-h-screen relative overflow-hidden bg-gray-950 font-mono p-6">
      ...
      <div className="relative z-10 max-w-2xl mx-auto p-6 space-y-6">
        ...
        <ul className="space-y-4">
          {candidates.map((c) => (
            <li key={c.id} className="bg-gray-500/10 border border-gray-700 rounded-lg p-4 flex items-center justify-between hover:bg-gray-500/20 transition-colors duration-300">
              <div>
